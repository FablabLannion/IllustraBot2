...
public class Connection extends Thread {
	...
	private OutputStream writerKernel;
    ...
    public void writeKernel(byte[] frame){

	        if (this.writerKernel != null ) {
	            try {
	            	this.writerKernel.write(frame);
	            	this.writerKernel.flush();
				} catch (IOException e) {
	...
	public void run() {
		...
		try {
			...
			this.writerKernel =this.callbackSocket.getOutputStream();
